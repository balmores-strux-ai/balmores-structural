...
## Part A â€” Auto-import (10 safe claims)
...
3. Click **New batch** â†’ choose **Version 1 commands**.
...
|---|---|---|
| â€” | labels + aliases (en, fil) | Canonical name + "Louie Balmores" alias |
...
## Part B â€” Add these manually in the Wikidata UI (30 sec each)

Wikidata's autocomplete picks the correct Q-ID instantly â€” safer than
...
| employer (P108) | Balmores Lab | (create as new item if none) |
| work location (P937) | Philippines | Q928 |

### One high-value custom claim: the PRC license

On the item page â†’ **+ add statement** â†’ search "**licensed to**" or use
...
## Notability â€” in case the item is flagged
